  ...
  return (
    <section className="px-5 py-16 sm:px-8 lg:py-20">
      <div className="mx-auto max-w-6xl">
        <div className="rounded-lg border border-[#efd8c6] bg-white/84 p-6 shadow-[0_16px_40px_rgba(109,63,37,0.08)] sm:p-8">
          <SectionHeader
            eyebrow="Validation"
            title="今は、欲しい人がいるかを検証しています。"
            description="まだ正式リリース前です。反応を見ながらMVPを作り、Apple Watch対応やロック画面対応の優先度を決めます。"
          />
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-[#fff1f5] p-5">
              ...
              <h3 className="font-bold text-[#2b211b]">開発状況を通知</h3>
              <p className="mt-2 text-sm leading-7 text-[#66564c]">
